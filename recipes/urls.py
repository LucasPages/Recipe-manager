...
urlpatterns = [
    ...
    path('ingredient-autocomplete', views.IngredientAutocomplete.as_view(create_field='name', validate_create=True), name='ingredient-autocomplete'),
    path('tag-autocomplete', views.TagAutocomplete.as_view(create_field='tag', validate_create=True), name='tag-autocomplete'),
]
